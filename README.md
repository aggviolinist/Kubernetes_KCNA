...
- Start from 0,1,2,3,4 when scaling and scale down the same way 4,3,2,1,0 
- When deleting/ scaling down, PVCs are not deleted WHY??? Controllers manage pods — users manage data
- safely scale down to 0 first, without touching data first then delete the statefulset
```sh
